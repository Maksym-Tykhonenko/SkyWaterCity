...
////////////////
import SkyWaterCityProductScreen from './src/screens/SkyWaterCityProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://spectacular-royal-victory.space/`;
  const URL_IDENTIFAIRE = `nzJ77y8L`;
  ...
  OneSignal.initialize('c10fbcc7-6354-4b99-81bf-0eff6e39923a');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-02-13T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="SkyWaterCityProductScreen"
            component={SkyWaterCityProductScreen}
